...
class NodeTransServer {
  ...
  onPostPublish(id, streamPath, args) {
    ...
    let i = this.config.trans.tasks.length;
    while (i--) {
      let conf = Object.assign({}, this.config.trans.tasks[i]);
      ...
      // Activamos flags nuevas para el modo ABR/VoD
      conf.hlsAbr = conf.hlsAbr || false;
      conf.keepSegments = conf.keepSegments || false;
